...
public class CommonUtils
{
   ...
   public static void initializeEnvAndUserType()
   {
      ...
      userLanguage = LanguageType.valueOf(
      ...
      pages.getConfiguration().getEnvironmentVariables().setProperty(
         ThucydidesSystemProperty.WEBDRIVER_BASE_URL.getPropertyName(),
         YamlUtils.getEnvUrlByEnyType(userRoleRoot, envType));
   ...
   public static String getCurrentDateAsUniqueString()
   {
      // SimpleDateFormat sdf = new SimpleDateFormat("ddMMyyyyhhmmss");
      ...
      return yearmonthdate.format(custDate);

   }

   public static String getCurrentDateRescheduleAsUniqueString()
   {
      SimpleDateFormat Resucheduleyearmonthdate = new SimpleDateFormat("MM/dd/yyyy");

      Date RescheduleCusDate = new Date();
      System.out.println(Resucheduleyearmonthdate.format(RescheduleCusDate));
      return Resucheduleyearmonthdate.format(RescheduleCusDate);
   }

   public static String getCurrentHourASUniqueString()
   {
      // SimpleDateFormat sdf = new SimpleDateFormat("ddMMyyyyhhmmss");
      SimpleDateFormat hour = new SimpleDateFormat("hh");
      Date custDate = new Date();
      System.out.println(hour.format(custDate));
      return hour.format(custDate);
   }

   public static String getCurrentMinutesAsUniqueString()
   {
      // SimpleDateFormat sdf = new SimpleDateFormat("ddMMyyyyhhmmss");
      SimpleDateFormat Min = new SimpleDateFormat("mm");
      Date custDate = new Date();
      System.out.println(Min.format(custDate));
      return Min.format(custDate);
   }

   public static String getCurrentDateInUIDateFormat()
   {
   ...
   public static long getDifferenceBetweenTwoDates(String date1, String date2)
   {
      SimpleDateFormat format = new SimpleDateFormat("yyyy-dd-mm hh:mm a");

      try
      {
         long timeDiffMilli= (format.parse(date1).getTime() - format.parse(date2).getTime());
         
         return TimeUnit.MINUTES.convert(timeDiffMilli, TimeUnit.MILLISECONDS);
      }
   ...
   {
     String date1= getCurrentDateInUIDateFormat();
     CommonUtils.waitForSeconds(120);
     String date2= getCurrentDateInUIDateFormat();
     
     long diff= getDifferenceBetweenTwoDates(date1, date2);
   ...
   public static Workbook ExcelWorkbook(String filePath, String fileName) throws IOException
   {
      File exCelSheet = excelFilePathObj(filePath, fileName);
   ...
   public static Sheet WriteExcel(String filePath, String fileName) throws IOException
   {
      ...
      // File extension Validation
      Workbook excelWorkorkBook = excelExtensionsCheck(inputStream, fileName);
      Sheet PageSheetWrite = excelWorkorkBook.getSheet("ContactId");
     
      
      return PageSheetWrite;
   ...
   public static File excelFilePathObj(String filePath, String fileName)
   {
      ...
      System.out.println("ExcelSheetFilePrint" +excelSheet);
      return excelSheet;
   }
